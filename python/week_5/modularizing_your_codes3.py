...
class NaijaPhone:
    ...
    def send_sms(self, message, number):
        ...
        return "Insufficirnt airtime to send sms"
...
# Using the encapsulation account
ibrahim_account = NigerianBankAccount("Ibrahim Orekunrin", 5000)

# These work - public interface
print(ibrahim_account.deposit(10000))   # ₦10, 000 deposited successfully
print(ibrahim_account.withdraw(5000, "1234"))   # ₦5, 000 withdrawn success fully
...
- Contol: You decide how data can be accessed
- Maintainance: Changes inside don't break outside code
"""
...
- When you board a Lagos Danfo
    ...
    - What don't see: Engine mechanics, fuel injection, electrical wiring
    - What you don't need to know: How engine converts fuel to motion
...
# Abstract base class - defines what a nigerian should do
class NigerianStudent(ABC):
    ...
    # create method - all students can do this
...
class MedicalStudent(NigerianStudent):
    def study_method(self):
        return f"{self.name} studies anatomy book and practices on cadavers"
...
class ComputerScienceStudent(NigerianStudent):
    ...
    def take_exam(self):
        return f"{self.name} take practical programing exam on computer"
    
# Using abstraction
students = [
    MedicalStudent("Dr. Adeyinka Ogunsanya", "Medcine", 400),
...
class SimplePhone:
    ...
    def _connect_to_sms_center(self):
        # complex connect sms center here
        pass
    
    def _format_message(self):
        # complex sms format here
        pass

    def _send_through_network(self):
        # compex networking code here
        pass
...
- Reusability: Same interface works for different implementation
"""

# Inheritance - Building on what already exist
"""
What is Inheritance?
Inheritance allows you to create new classes based on existing ones. The new class (child) inherits attributes and methods from the parent class, and can add its own features or modify exiting ones.
- Real-World Analogy
    - Thinking of a Nigeria family
        - Parent (Father): Adebayo Ogundimu - has surname, family traditions, property
        - Child 1 (Son): Kemi Ogundimu - inherits surname, traditions, get family property + adds his own career as doctor
        - Child 2 (Daugther): Tunde Ogundimu - inherits surname, traditions, get family property + adds her own career as engineer
...
class NigerianStudent(NigerianPerson):
    ...
    def introduce(self):
        parent_intro = super().introduce()  # get parent's intoduction
...
class NigerianWorker(NigerianPerson):
    def __init__(self, first_name, last_name, state_of_origin, job_tittle, company):
        super().__init__(first_name, last_name, state_of_origin)
        self.job_title = job_tittle
    ...
    def receive_salary(self, amount):
        self.salary += amount
        return f"{self.first_name} recieved ₦{amount:,} salary"
...
# Using inheritance
# Create different typesa of people
student = NigerianStudent("kemi", "Adebayo", "Lagos State", "computer", 300)
...
print(teacher.teach())          # Only teacher can do this
...
child = Child()
print(child.father_trait()) # Stong
...
- Maintainance: Fix bugs in parent class, all children benefit
...
class SchoolMember(ABC):
    def __init__(self, name, id_number):
        ...
        self._id_number = id = id_number    # Encapsulation - protected attribute
...
class Student(SchoolMember):
    ...
    def add_grade(self, subject, score):     # Encapsulation - controlled access
        if 0 <= 100:
            ...
            return f"Graade added: {subject} = {score}"
